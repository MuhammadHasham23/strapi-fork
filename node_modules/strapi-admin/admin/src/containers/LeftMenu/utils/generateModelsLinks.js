  ...
  return links
    ...
    .map(link => {
      const collectionTypesPermissions = [
        { action: 'plugins::content-manager-mock.explorer.create', subject: link.uid },
        { action: 'plugins::content-manager-mock.explorer.read', subject: link.uid },
      ];
      ...
      return {
        icon: 'circle',
        destination: `/plugins/content-manager-mock/${link.kind}/${link.uid}`,
        isDisplayed: true,
