...
const InputModalStepperProvider = ({
  ...
  const downloadFiles = async () => {
    ...
    if (files.length > 0) {
      emitEvent('didSelectFile', { source: 'url', location: 'content-manager-mock' });
    }
  ...
  const handleSetCropResult = blob => {
    ...
    emitEvent('didCropFile', { duplicatedFile: null, location: 'content-manager-mock' });
  ...
  const addFilesToUpload = ({ target: { value } }) => {
    emitEvent('didSelectFile', { source: 'computer', location: 'content-manager-mock' });
