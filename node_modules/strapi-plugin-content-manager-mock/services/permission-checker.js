...
const ACTIONS = {
  read: 'plugins::content-manager-mock.explorer.read',
  create: 'plugins::content-manager-mock.explorer.create',
  update: 'plugins::content-manager-mock.explorer.update',
  delete: 'plugins::content-manager-mock.explorer.delete',
  publish: 'plugins::content-manager-mock.explorer.publish',
  unpublish: 'plugins::content-manager-mock.explorer.publish',
};
