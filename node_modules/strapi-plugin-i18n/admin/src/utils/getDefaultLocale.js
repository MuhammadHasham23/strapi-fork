...
const getDefaultLocale = (ctPermissions, locales = []) => {
  ...
  const readPermissions = ctPermissions['plugins::content-manager-mock.explorer.read'];
  const createPermissions = ctPermissions['plugins::content-manager-mock.explorer.create'];
